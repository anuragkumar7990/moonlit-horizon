...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|api/webhook/|api/intel-triggers/gmail|api/sync-account-rename|api/setup-zoho-webhooks|api/webhook/status|api/backfill-zoho-calls).*)'],
}
