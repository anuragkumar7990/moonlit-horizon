...
export default function MaheshView() {
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center py-24">
        ...
        <h1 className="text-xl font-semibold text-mh-text">Mahesh&apos;s View</h1>
        <p className="text-mh-muted text-sm mt-2">Building in Phase 1b</p>
        <p className="text-mh-muted text-xs mt-1">Weekly summary · Reports · Stats · Funnel · Reminders</p>
      </div>
    </div>
  )
}
